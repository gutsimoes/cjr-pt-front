...
export default function Home() {
  ...
  return (
    <>
          ...
          <section>
            ...
            <div className="mt-4">
              <button
                ...
                className="bg-teal-700 hover:bg-teal-600 text-white px-4 py-2 rounded-lg shadow-lg cursor-pointer"
              >
                + Novo Professor
              </button>
            </div>
      ...
      {/* 5. Renderize o ProfessorModal condicionalmente */}
      {modalAberto && <ProfessorModal onClose={() => setModalAberto(false)} />}
    </>
  );
}