    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 shadow-lg">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <button
          ...
          className="hidden md:flex items-center gap-2 text-[#043452]/90 font-medium drop-shadow-md hover:text-[#043452] transition-colors"
        >
          <User size={20} />
          <span>Perfil</span>
        </button>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#ffa45d] to-amber-500 text-white font-semibold rounded-full hover:from-[#ff9a47] hover:to-amber-600 transition-all shadow-lg"
